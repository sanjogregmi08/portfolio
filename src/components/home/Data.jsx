...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"> Sanjog Regmi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">ML-Aspirant / Data Analyst </h3>
            <p className="home__description">
            Eager Bachelor's graduate with a passion for data-driven decision making, poised to advance in the field of Machine Learning. Ready to contribute innovative solutions and grow within a dynamic technology team
            </p>            <a href="#contact" className="button button--flex">
                Say Hello
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
